...
ENT.PrintName       = "Wire Lockable Button"
ENT.WireDebugName	= "Lockable Button"
...
duplicator.RegisterEntityClass("gmod_wire_lockable_button", WireLib.MakeWireEnt, "Data", "toggle", "allow_set_lock", "lock_controlled_toggle", "output_lock_state", "value_off", "value_on", "description", "entityout" )
